...
> _Question:_ What do these distributions tell us about our count data?
 
 `r hide("Show Answer")`
 
 * Most loci have 0 counts. Why might that be?
...
> _Question:_ How many repliactes do we have per tissue type per background?
...
We can now pass this transformed counts data to a canned PCA function

```{r}
# run PCA on top 500 most variable genes
...
> _Question:_ Do all of our genes have homologous genes in *X. tropicals*? And are they all annotatated? What does this mean?
...
> _Question:_ What genes from these pathways did we recover and are they expressed in a way that we expect?
